        ...
        <div
            ...
            <div class="sm:w-1/2 xl:w-2/5 h-full hidden md:flex flex-auto items-center justify-start p-10 overflow-hidden text-white bg-no-repeat bg-cover relative"
                ...
                <div class="w-full max-w-md z-10">
                    <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Junte-se ao futuro sustentável</div>
                    <div class="sm:text-sm xl:text-md text-gray-200 font-normal">Tecnologia inovadora para transformar
                        resíduos em recompensas! Seja parte da revolução verde e faça a diferença no mundo.</div>
                </div>
                <ul class="circles">
                    <li></li>
                    <li></li>
            ...
            <div
                ...
                <div class="max-w-md w-full space-y-8">
                    <div class="text-center">
                        <h2 class="mt-6 text-3xl font-bold text-lime-400">Criar conta</h2>
                        <p class="mt-2 text-sm text-slate-300">Inicie sua jornada sustentável</p>
                    </div>
                    <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Campo Nome -->
                        <div>
                            <label for="name" class="ml-3 text-sm font-bold text-green-400 tracking-wide">Nome
                                completo</label>
                        ...
                        <!-- Campo CPF -->
                        <div>
                            <label for="cpf" class="ml-3 text-sm font-bold text-green-400 tracking-wide">CPF</label>
                            <div class="relative mt-1">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><i
                                        data-lucide="id-card" class="h-5 w-5 text-gray-400"></i></div>
                                <input maxlength="14" id="cpf" name="cpf" type="text" required
                                    autocomplete="cpf" oninput="mascaraCPF(this)"
                                    class="w-full text-base pl-10 pr-4 py-2 border-b focus:outline-none rounded-2xl focus:border-green-500 @error('cpf') border-red-500 @else border-emerald-900 @enderror"
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="ml-3 text-sm font-bold text-green-400 tracking-wide">Confirmar Senha</label>
                            <div class="relative mt-1">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><i
                        ...
                        <div class="pt-4">
                            <button type="submit"
                                ...
                                <span
                                    class="absolute inset-0 flex justify-center items-center text-white font-bold opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-hover:delay-200 z-20">Acessar!</span>
                                <span class="z-20 transition-opacity duration-300 group-hover:opacity-0">Criar minha
                                    conta</span>
                                <span
